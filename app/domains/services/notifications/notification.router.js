...
notificationRouter.get('/', verifyToken, notificationController.pending);
...
notificationRouter.post('/decide', verifyToken, notificationController.decide);

// Refuses unless this deployment is configured to contact subjects at all.
notificationRouter.post('/deliver', verifyToken, notificationController.deliver);
